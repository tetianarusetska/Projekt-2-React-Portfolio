...
export default function Project3() {
    return <div>
        <a href="/" className="inline-block mt-[30px] mx-[260px] text-[25px] font-extralight">
            Home
        </a>
        ...
        <div className="project1 flex flex-col justify-center items-center gap-[50px] mb-[20px]">
            ...
            <p className="my-[40px] px-[260px] flex flex-col gap-[20px] w-[655] h-[146px] leading-[1.2em] font-[Montserrat, sans-serif] text-[20px] font-extralight">
            ...
            <a
                ...
                className="-translate-y-20 underline px-[260px] leading-[1.2em] font-[Montserrat, sans-serif] text-[20px] font-extralight"
            >
                Projekt anschauen
            </a>
            ...
            <a
                ...
                className="underline -translate-y-30 px-[260px] leading-[1.2em] font-[Montserrat, sans-serif] text-[20px] font-extralight"
            >
                Github
            </a>

            <img src={img12} alt="img12" className="w-[793px] h-[489px] -translate-y-10" />
            <img src={img15} alt="img15" className="w-[793px] h-[489px] -translate-y-10" />
            <img src={img13} alt="img13" className="w-[793px] h-[489px] -translate-y-10" />
            <img src={img14} alt="img14" className="w-[793px] h-[489px] -translate-y-10" />
            <img src={img16} alt="img16" className="w-[793px] h-[489px] -translate-y-10" />
