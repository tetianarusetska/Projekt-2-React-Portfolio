...
export default function Project4() {
    return <div>
        ...
        <div className="project4 flex flex-col justify-center items-center gap-[50px] mb-[20px]">
            ...
            <img src={cover} alt="img17" className="w-[993px] h-[589px] -translate-y-30" />
            <img src={img21} alt="img21" className="w-[993px] h-[589px]" />
            <img src={img23} alt="img23" className="w-[993px] h-[589px]" />
            <img src={img24} alt="img24" className="w-[993px] h-[589px]" />
            <img src={favoriten} alt="img26" className="w-[993px] h-[589px]" />
            <img src={collections} alt="img27" className="w-[993px] h-[589px]" />
            <img src={checkout} alt="img28" className="w-[993px] h-[589px]" />
            <img src={profile} alt="img25" className="" />
            <img src={screen1} alt="img29" className='w-200 h-300' />
            <img src={screen2} alt="img30" className='w-200 h-200' />
            <img src={screen3} alt="img31" className='w-200 h-300' />
            <img src={screen4} alt="img32" className="w-[993px] h-[589px]" />
            <img src={screen5} alt="img33" className="w-[993px] h-[589px] mb-20" />
