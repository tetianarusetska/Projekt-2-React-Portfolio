...
export default function Project1() {
    return <div>
        ...
        <div
            className="project1 flex flex-col justify-center items-center gap-[40px]"
        >
            <p
                className="text-center leading-[1.2em] font-[Montserrat, sans-serif] text-[32px] font-extralight mt-[50px]"
            >
                "Yehor Lemzyakoff" (Figma) UI, UX
            </p>
            <p
                className="mt-[40px] px-[260px] flex flex-col gap-[20px] w-[655] h-[146px] leading-[1.2em] font-[Montserrat, sans-serif] text-[20px] font-extralight"
            >
            ...
            />
            <div
                className="flex flex-row gap-[14px] mb-[20px]"
            >
                <img
                    src={img5}
                    alt="img5"
                    className="w-[392px] h-[1009px]"
                />
                <img
                    src={img6}
                    alt="img6"
                    className="w-[276px] h-[1006px]"
                />
                <img
                    src={img7}
                    alt="img7"
                    className="w-[260px] h-[1009px]"
                />
            </div>
        </div>
    </div>
