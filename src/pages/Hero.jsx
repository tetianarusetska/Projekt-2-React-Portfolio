...
function Hero() {
    return <div
        ...
        <div
            className="subtitles
            min-w-screen flex flex-row items-center justify-center text-[29px]leading-[1.2em] translate-y-60 font-[MelodramaLight] 
            md:gap-40 md:text-[32px] md:translate-y-70
            lg:gap-80 lg:text-[55px] lg:translate-y-80
            "
        >
            <p
